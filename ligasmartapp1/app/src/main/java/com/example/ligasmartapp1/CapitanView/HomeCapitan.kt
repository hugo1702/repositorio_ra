...
import com.example.ligasmartapp1.CardPage
import com.example.ligasmartapp1.CardYoutube
...
@Composable
fun HomeCapitan(navController: NavHostController) {
...
//                    onClick = { /* Acción de la notificación */ }) {
//                    Icon(Icons.Rounded.Notifications, contentDescription = "Notificaciones", tint = Color.Gray)
//                }
//            }
        )
        ...
        // Otros componentes como CardYoutube() y CardPage()
        CardYoutube()
        CardPage()
    }
}
